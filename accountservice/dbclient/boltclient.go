...
import (
	"microdemo/micro/accountservice/modle"
...
type IBoltClient interface {
	OpenBoltDB()
	QueryAccount(accountId string)(modle.Account,error)
	Seed()
}
...
func (bc *BoltClient) QueryAccount(accountId string) (modle.Account, error) {
